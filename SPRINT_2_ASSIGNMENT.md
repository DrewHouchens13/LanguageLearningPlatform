...
– AI Code Review using OpenAI Platform for each Pull Request (5pts)

– Running automated tests for each commit (2.5pts)

– Reports test coverage metrics in console for each commit (2.5pts)

5) Deployed to a production environment (10pts)

6)  NEW: CD Pipeline that runs when code is merged into master/main (50 pts)
...
Submission:
    ...
    ONE team member, post to your Dev_Cust Group on Discord with information about what was implemented and your application's devedu.io app URL address (Example: app-containername-5.devedu.io). Customers will see and can write posts to/from their developers.

    AI Documentation You must document in your project README where and when you got help from AI and include the transcript URL for each instance of support.
    Reminder: Complete your Kritik Evaluations! The first opens immediately after the sprint deadline.  The activity has three stages to complete. Check the schedule to the right of your screen to note the deadlines to submit for each stage.
